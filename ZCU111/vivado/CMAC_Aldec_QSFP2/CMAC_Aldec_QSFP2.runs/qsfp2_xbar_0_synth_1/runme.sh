...
HD_PWD='e:/KaOs_Tech/GitHub/100GBE-PYNQ/ZCU111/vivado/CMAC_Aldec_QSFP2/CMAC_Aldec_QSFP2.runs/qsfp2_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log qsfp2_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source qsfp2_xbar_0.tcl
