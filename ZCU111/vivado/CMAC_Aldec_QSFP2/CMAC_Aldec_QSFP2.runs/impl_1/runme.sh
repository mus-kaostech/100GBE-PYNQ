...
HD_PWD='e:/KaOs_Tech/GitHub/100GBE-PYNQ/ZCU111/vivado/CMAC_Aldec_QSFP2/CMAC_Aldec_QSFP2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log qsfp2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source qsfp2_wrapper.tcl -notrace
